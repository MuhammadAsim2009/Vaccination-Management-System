...
if(isset($_POST['register_btn'])) {
    ...
    try {
        ...
        send_notification($conn, 'admin', null, $user_id, 'system', 'New Hospital Registration', "A new hospital, " . htmlspecialchars($hospital_name) . ", has registered and is pending approval.");
